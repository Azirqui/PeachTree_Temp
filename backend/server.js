...
//starting from here commented Usman
// Login route
...
// ---------------------------------------- Code Noman Product ---------------------------------------------------
const productRoutes = require('./routes/productRoutes');  // Import combined routes
app.use('/api/products', productRoutes);  // Handles GET, POST, DELETE